...
## Corpus Check
- 24 files · ~5,857 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 128 nodes · 165 edges · 16 communities (13 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8455e99`
...
Cohesion: 0.11
Nodes (21): after, Audience(), audiences, before, Comparison(), FAQ(), faqs, FinalCTA() (+13 more)
...
Cohesion: 0.33
Nodes (7): areas, roleGroups, AppWindow(), Insight(), ProductButton(), Progress(), SectionIntro()
...
## Knowledge Gaps
- **63 isolated node(s):** `requiredFields`, `Submission`, `geist`, `mono`, `metadata` (+58 more)

...
## Corpus Check
- 97 files · ~34,784 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 347 nodes · 636 edges · 25 communities (21 shown, 4 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4cff4a72`
...
Cohesion: 0.10
Nodes (11): AppShell(), items, Props, CaptureProcess(), InitialCapture, mediaStages, Role, textStages (+3 more)

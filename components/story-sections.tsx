    ...
    <section className="section border-y border-[#e6eaf0] bg-white">
      <div className="container-shell grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
        <div className="reveal">
          ...
          <p className="mt-4 leading-7 text-[#637084]">Opryn turns it into something the whole team can actually use.</p>
        </div>
  ...
  return (
    <section id="how-it-works" className="section">
      <div className="container-shell">
        <SectionIntro label="How Opryn works" title="Don't write a manual. Just do your job." copy="Opryn captures the way work actually happens—then turns it into guidance your team can use." center />
        <div className="mt-16 grid gap-5 lg:grid-cols-2">
          <Step number="01" title="Work normally" copy="Record yourself performing a task. Opryn watches the workflow while you explain things naturally.">
          ...
          <Step number="02" title="Opryn learns" copy="It identifies the steps, tools, decisions, rules, exceptions, and responsibilities behind the work.">
          ...
          <Step number="03" title="Opryn asks what it missed" copy="A few precise questions capture the exceptions and decisions that live between the steps.">
          ...
          <Step number="04" title="Your team can now ask Opryn" copy="Employees get answers grounded in your business—not generic advice from the internet.">
